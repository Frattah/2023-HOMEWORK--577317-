...
//
//public class LabirintoBuilderTestDocente {
...
//				.addAttrezzo(nomeAttrezzo, peso)
//				.getLabirinto();
//		assertTrue(this.labirintoBuilder.getMappaStanze().get(nomeStanza).getListaAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
...
//				.getLabirinto();
//		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
//		List<Attrezzo> attrezzi = labirintoBuilder.getMappaStanze().get(nomeStanza).getListaAttrezzi();
